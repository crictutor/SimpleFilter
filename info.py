...
SHORTLINK_API = environ.get('SHORTLINK_API', 'vnPYrccG5of0IHeAz5FyL4XHbAI2')
...
UPDT_CHNL = environ.get('UPDT_CHNL', 'https://t.me/Movies_bhandars')
MY_CHNL = environ.get('MY_CHNL', 'https://t.me/Movies_bhandars')
MY_GRP = environ.get('MY_GRP', 'https://t.me/+eT1rbp5RgyswZjE1')
HOW_TO_DWNLD  = environ.get('HOW_TO_DWNLD', 'https://t.me/Movies_bhandars')
READ_RULES = environ.get('READ_RULES', 'https://t.me/Movies_bhandars')

LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001965370358')) 
REQUEST_LOGS = int(environ.get('REQUEST_LOGS', '-1001924056649)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Movies_bhandars')
